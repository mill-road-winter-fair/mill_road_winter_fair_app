...
class FavouriteListingsPage extends StatefulWidget {
  const FavouriteListingsPage({super.key, required this.listings});
...
class _FavouriteListingsPageState extends State<FavouriteListingsPage> {
  ...
  @override
  void initState() {
    debugPrint('FavouriteListingsPageState initState() called');
    super.initState();
  }

  @override
  void dispose() {
    debugPrint('FavouriteListingsPageState dispose() called');
  ...
  Widget build(BuildContext context) {
    debugPrint('FavouriteListingsPage build() called');
    ...
    // Step 1: Filter by favourite flag
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: FloatingActionButton(
                          ...
                          heroTag: 'nowFab_favouriteListings_page',
                      ...
                      SizedBox(
                        ...
                        child: FloatingActionButton(
                          ...
                          heroTag: 'hidePastListingsFab_favouriteListings_page',
                      ...
                      SizedBox(
                        ...
                        child: FloatingActionButton(
                          ...
                          heroTag: 'searchFab_favouriteListings_page',
                          backgroundColor: Theme.of(context).colorScheme.secondary,
