              ...
              children: [
                ConstrainedBox(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/importantInfoPage/hiVis_cropped.jpg',
                      fit: BoxFit.fitWidth,
                    ),
                  ),
                ),
                ...
                bulletPoint(
                  'Stewards wearing hi-vis jackets are available to assist you.',
                ),
                bulletPoint(
                  'To help ensure your safety, please comply promptly with any instructions from stewards.',
                ),
                bulletPoint(
                  'If you see anything unsafe or suspicious, please report it to a steward immediately.',
                ),
                bulletPoint(
                  'In an emergency, follow instructions from stewards or the emergency services.',
                ),
                bulletPoint(
                  'Please respect residents and do not trespass in private gardens.',
                ),
                const SizedBox(height: 20),
                ConstrainedBox(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: Image.asset(
                      'assets/importantInfoPage/cautionVehicles_cropped.jpg',
                      fit: BoxFit.fitWidth,
                    ),
                  ),
                ),
                ...
                const Text(
                  'If you require first aid, ask the nearest steward or go to Mill Road Baptist Church.',
                ),
                const SizedBox(height: 20),
                ConstrainedBox(
                  constraints: const BoxConstraints(maxHeight: 250),
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: Image.asset(
                      'assets/importantInfoPage/carousel01_cropped.jpg',
                      fit: BoxFit.fitWidth,
                    ),
                  ),
                ),
                ...
                const SizedBox(height: 10),
                bulletPoint(
                  'Please arrange your own family meeting point in case you become separated.',
                ),
                ...
                const SizedBox(height: 10),
                bulletPoint(
                  'Please follow Mill Road Winter Fair on social media for the latest news and updates or check this app for the latest listings.',
                ),
                        ...
                        child: Text.rich(
                          TextSpan(
                            children: [
                              const TextSpan(
                                text:
                                    'Email addresses for the Fair can be found ',
                              ),
                              TextSpan(
                                text: 'here',
                                style: const TextStyle(
                      ...
                      Expanded(
                        child: Text.rich(
                          TextSpan(
                            children: [
                              const TextSpan(
                                text: 'On the day, you can also phone ',
                              ),
                              TextSpan(
                                text: '07303 142689',
                                style: const TextStyle(
