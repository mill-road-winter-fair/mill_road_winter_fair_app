      ...
      appBarActions: [
        IconButton(
          ...
          onPressed: () {
            ...
            context.read<AnalyticsService>().logButtonTapped('chooser_about_fair');
            Navigator.push(context, MaterialPageRoute(builder: (context) => AboutTheFairPage()));
          },
        ),
      ],
      body: Scrollbar(
              ...
              TextSpan(children: [
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_music');
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_other');
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_music_now');
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_other_now');
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_listings_music');
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_listings_other');
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_listings_children');
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_favourites_music');
                ...
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        HapticFeedback.lightImpact();
                        context.read<AnalyticsService>().logButtonTapped('chooser_map_nearest');
                        widget.onOpenMap(10);
                      }),
              ]),
