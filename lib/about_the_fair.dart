...
class TextImageRow extends StatelessWidget {
  ...
  TextImageRow({required this.textSpan, required this.imagePath, required this.textWidthProportion, this.imageOnLeft = false});
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 12),
              TextImageRow(
                textSpan: const TextSpan(text: 'Be sure to come early so that you don’t miss out; we have so much to see! The fire engine pull, opening ceremony, dance show and parade are all in the morning, as well as lots of amazing stalls, performance and events.',),
              ...
              const SizedBox(height: 12),
              TextImageRow(
                textSpan: const TextSpan(text: 'We are grateful for the support of our generous sponsors: Bush & Co Sales and Lettings (lead sponsor), Anglia Ruskin University, Hughes Hall, Taank Optometrists, Regalstar catering and Love Mill Road. The Mill Road Winter Fair is supported by a Cambridge City Council Community Grant and the Mill Road Traders Association.',),
