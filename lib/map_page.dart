...
class MapPageState extends State<MapPage> {
  ...
  Polygon roadClosurePolygon() {
    ...
    roadClosurePolygonPoints.add(const LatLng(52.20106844993226, 0.1315253363853319));
    roadClosurePolygonPoints.add(const LatLng(52.20103421843005, 0.1316559892682845));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.20016584154402, 0.1367620437365646));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.19958261328397, 0.1364065159925199));
    roadClosurePolygonPoints.add(const LatLng(52.19954898172398, 0.1365440921302419));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.19960936113253, 0.1381715386581228));
    roadClosurePolygonPoints.add(const LatLng(52.19958650615419, 0.1381953576575357));
    roadClosurePolygonPoints.add(const LatLng(52.19955963533969, 0.1381996076168601));
    roadClosurePolygonPoints.add(const LatLng(52.19884237379668, 0.1377490332439679));
    roadClosurePolygonPoints.add(const LatLng(52.19881018785336, 0.1378921716081694));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.19939091995905, 0.1386707785667762));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.19797947132578, 0.1454329039144864));
    roadClosurePolygonPoints.add(const LatLng(52.19800752581801, 0.1453228813565022));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.19833261563045, 0.1432807760516064));
    roadClosurePolygonPoints.add(const LatLng(52.19835377290364, 0.1431662209071161));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.19898785139732, 0.1401239799499643));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.19963025582913, 0.1401080962473711));
    roadClosurePolygonPoints.add(const LatLng(52.1996530182158, 0.1399920752150696));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.20045825493622, 0.1388467678964456));
    roadClosurePolygonPoints.add(const LatLng(52.20048474101069, 0.1387164074398561));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.20044131744082, 0.1363590732360365));
    ...
    roadClosurePolygonPoints.add(const LatLng(52.20208212214061, 0.1323470401379923));
    roadClosurePolygonPoints.add(const LatLng(52.20217853160824, 0.1322296546103541));
