                ...
                builder: (context, constraints) {
                  ...
                  return PopScope(
                    ...
                    child: GoogleMap(
                        ...
                        myLocationEnabled:
                            locationServicesEnabled && (locationPermission == LocationPermission.always || locationPermission == LocationPermission.whileInUse),
                        ...
                        children: [
                          if (navigationInProgress == false)
                            FloatingActionButton(
                              ...
                              onPressed: () {
                                HapticFeedback.lightImpact();
                                context.read<AnalyticsService>().logButtonTapped('map_filter');
                                showFilterMenu();
                                setVisibleMarkerLists();
                              },
                              backgroundColor: Colors.transparent,
